            ...
            <div className="flex flex-col items-stretch justify-between gap-3 sm:flex-row sm:items-center sm:gap-4">
                ...
                <div className="relative w-full sm:w-64">
                    <input
                        ...
                        className="w-full rounded-lg border border-gray-300 py-2 pr-4 pl-9 text-sm text-gray-900 focus:border-transparent focus:ring-2 focus:ring-green-500 sm:pl-10 sm:text-base"
                    />
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
