...
export default function GuruManagement({ auth, guru, totalGuru }: GuruManagementProps) {
    ...
    // Search guru
    const searchedGuru = guru.filter(teacher => 
            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
                        <div>
                            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Kelola Guru</h1>
                            <p className="text-sm sm:text-base text-gray-600 mt-1">Manajemen data guru</p>
                        </div>
                        <button
                            onClick={() => setShowAddModal(true)}
                            className="bg-green-600 hover:bg-green-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-semibold transition-colors flex items-center gap-2 w-full sm:w-auto justify-center"
                        >
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 lg:p-6 border-l-4 border-green-500">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-2">
                                <div className="flex-1">
                                    <p className="text-xs sm:text-sm font-medium text-gray-600 mb-0.5 sm:mb-1">Total Guru</p>
                                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-600">{totalGuru}</p>
                                </div>
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 mb-4 sm:mb-6">
                        <div className="relative w-full sm:w-64">
                            <input
                                ...
                                className="w-full pl-9 sm:pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                            />
                            <svg
                    ...
                    <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
                        <div className="overflow-x-auto">
                            <table className="w-full min-w-[640px]">
                                ...
                                <tbody>
                                    {paginatedGuru.map((teacher) => (
                                        <tr key={teacher.id} className="border-b border-gray-200 hover:bg-gray-50">
                                            <td className="py-3 px-2 sm:py-4 sm:px-4">
                                                <span className="font-medium text-gray-900 text-xs sm:text-sm">{teacher.id}</span>
                                            </td>
                                            <td className="py-3 px-2 sm:py-4 sm:px-4">
                                                <span className="font-medium text-gray-900 text-xs sm:text-sm">{teacher.name}</span>
                                            </td>
                                            <td className="py-3 px-2 sm:py-4 sm:px-4">
                                                <span className="text-gray-600 text-xs sm:text-sm">{teacher.email}</span>
                                            </td>
                                            ...
                                            <td className="py-3 px-2 sm:py-4 sm:px-4">
                                                <div className="flex justify-center gap-1 sm:gap-2">
                                                    <button className="bg-green-500 hover:bg-green-600 text-white px-2 sm:px-3 py-1 rounded-lg text-xs sm:text-sm font-medium transition-colors">
                                                        Edit
                                                    </button>
                        ...
                        {paginatedGuru.length === 0 && (
                            <div className="p-8 text-center">
                                <p className="text-gray-600 font-medium">
                                    {searchQuery ? `Tidak ada hasil untuk "${searchQuery}"` : 'Tidak ada data guru'}
                                </p>
                            </div>
                        )}
                        ...
                        <div className="flex items-center justify-between p-4 border-t border-gray-200">
                            <div className="flex items-center gap-3">
                                ...
                                <select
                                    ...
                                    className="px-3 py-2 border border-gray-300 rounded-lg text-sm font-medium bg-white text-gray-700 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
                                >
                        ...
                        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                            <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 max-w-2xl w-full">
                                <div className="flex items-center justify-between mb-4 sm:mb-6">
                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Tambah Guru Baru</h2>
                                    <button
                                ...
                                <form className="space-y-3 sm:space-y-4">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm text-gray-900"
                                            />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 mt-4 sm:mt-6">
                                        ...
                                        <button
                                            type="submit"
                                            className="px-4 sm:px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm sm:text-base font-medium transition-colors"
                                        >
                                            Simpan Guru
                                        </button>
                                    </div>
