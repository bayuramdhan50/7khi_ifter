                                        ...
                                        <div className="p-4 space-y-3">
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div className="text-xs text-gray-500">Kegiatan Bermasyarakat</div>
                                                        <div className="text-sm font-semibold text-gray-700">Sudah Kegiatan</div>
                                                    </div>
                                                </div>
                                                <input
                                                    type="checkbox"
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200 bg-gray-50">
                                                ...
                                                <th className="py-4 px-4 text-center font-bold text-gray-700 text-sm whitespace-nowrap">KEGIATAN BERMASYARAKAT</th>
                                                ...
                                                <tr key={day} className="border-b border-gray-200 hover:bg-blue-50 transition-colors">
                                                    ...
                                                    <td className="py-4 px-4">
                                                        <div className="flex justify-center">
                                                            <input
                                                                type="checkbox"
                                                                className="w-6 h-6 rounded border-2 border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500 cursor-pointer"
                                                            />
                                                        </div>
                                                    </td>
                        ...
                        <div className="space-y-4">
                            {(() => {
                                ...
                                const socialActivities = [
                                    ...
                                    { key: 'kerjaBakti', label: 'Kerja Bakti' },
                                    { key: 'gotongRoyong', label: 'Gotong Royong' },
                                    { key: 'lainnya', label: 'Lainnya' }
                                ];
                                return (
                                    <>
                                        {socialActivities.map(({ key, label }) => (
