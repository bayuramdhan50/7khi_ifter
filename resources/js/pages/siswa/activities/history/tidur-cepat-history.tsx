...
export default function TidurCepatHistory({ auth, activity, submissions }: TidurCepatHistoryProps) {
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="md:hidden space-y-3">
                                {days.map((day) => {
                                    ...
                                    const waktuBerolahraga = submission?.details.waktu_tidur?.value || '';
                                                ...
                                                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="text-xs text-gray-500">Waktu Tidur</div>
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200 bg-gray-50">
                                                ...
                                                <th className="py-4 px-4 text-center font-bold text-gray-700 text-sm whitespace-nowrap">WAKTU TIDUR</th>
