                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200">
                                                ...
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">KARBOHIDRAT</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">PROTEIN</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">SAYUR</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">BUAH</th>
                                        ...
                                        <tbody>
                                            {days.map((day) => (
                                                <tr key={day} className="border-b border-gray-200 hover:bg-gray-50">
                                                    ...
                                                    {/* Karbohidrat */}
                                                    <td className="py-3 px-4">
                                                        <select className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-800">
