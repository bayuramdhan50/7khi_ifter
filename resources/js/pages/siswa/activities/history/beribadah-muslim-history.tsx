                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200">
                                                ...
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Subuh</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Dzuhur</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Ashar</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Maghrib</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Isya</th>
                                            ...
                                            {days.map((day) => (
                                                <tr key={day} className="border-b border-gray-200 hover:bg-gray-50">
                                                    ...
                                                    {['subuh', 'dzuhur', 'ashar', 'maghrib', 'isya'].map((prayer) => (
                                                        <td key={prayer} className="py-3 px-2">
