                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200 bg-gray-50">
                                                ...
                                                <th className="py-4 px-2 text-center font-bold text-gray-700 text-sm">Subuh</th>
                                                <th className="py-4 px-2 text-center font-bold text-gray-700 text-sm">Dzuhur</th>
                                                <th className="py-4 px-2 text-center font-bold text-gray-700 text-sm">Ashar</th>
                                                <th className="py-4 px-2 text-center font-bold text-gray-700 text-sm">Maghrib</th>
                                                <th className="py-4 px-2 text-center font-bold text-gray-700 text-sm">Isya</th>
                                                ...
                                                <th className="py-4 px-3 text-center font-bold text-gray-700 text-sm whitespace-nowrap">DETAIL</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {days.map((day) => (
