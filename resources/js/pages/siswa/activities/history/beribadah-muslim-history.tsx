                                    ...
                                    <table className="w-full lg:min-w-max">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200 bg-gray-50">
                                                <th className="py-2 sm:py-4 px-2 sm:px-4 text-center font-bold text-gray-700 text-xs sm:text-sm whitespace-nowrap">TGL</th>
                                                <th className="py-2 sm:py-4 px-2 text-center font-bold text-gray-700 text-xs sm:text-sm">Subuh</th>
                                                <th className="py-2 sm:py-4 px-2 text-center font-bold text-gray-700 text-xs sm:text-sm">Dzuhur</th>
                                                <th className="py-2 sm:py-4 px-2 text-center font-bold text-gray-700 text-xs sm:text-sm">Ashar</th>
                                                <th className="py-2 sm:py-4 px-2 text-center font-bold text-gray-700 text-xs sm:text-sm">Maghrib</th>
                                                <th className="py-2 sm:py-4 px-2 text-center font-bold text-gray-700 text-xs sm:text-sm">Isya</th>
                                                <th className="py-2 sm:py-4 px-2 sm:px-3 text-center font-bold text-gray-700 text-xs sm:text-sm whitespace-nowrap">APPROVAL<br className="sm:hidden"/>ORTU</th>
                                                <th className="py-2 sm:py-4 px-2 sm:px-3 text-center font-bold text-gray-700 text-xs sm:text-sm whitespace-nowrap">BUKTI<br className="sm:hidden"/>FOTO</th>
                                                <th className="py-2 sm:py-4 px-2 sm:px-3 text-center font-bold text-gray-700 text-xs sm:text-sm whitespace-nowrap">DETAIL</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {days.map((day) => (
                                                <tr key={day} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                                                    ...
                                                    {['subuh', 'dzuhur', 'ashar', 'maghrib', 'isya'].map((prayer) => (
                                                        <td key={prayer} className="py-2 sm:py-3 px-1 sm:px-2">
                                                            <div className="flex justify-center items-center">
                                                                <input
                                                                    type="checkbox"
                                                                    className="w-5 h-5 sm:w-6 sm:h-6 border-2 border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-blue-600 cursor-pointer"
                                                                />
                                                            </div>
                                                        </td>
                                                    ))}
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="space-y-4">
                            {(() => {
                                ...
                                const afterPrayers = [
                                    { key: 'mengaji', label: 'Mengaji' },
                                    { key: 'berdoa', label: 'Berdoa' },
                                    { key: 'bersedekah', label: 'Bersedekah' },
                                    { key: 'lainnya', label: 'Lainnya' }
                                ];
                                return (
                                    <>
                                        {afterPrayers.map(({ key, label }) => (
