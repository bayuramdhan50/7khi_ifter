                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200">
                                                ...
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Doa Pagi</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Baca Firman</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Catat Firman</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Ibadah</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700">Pelayanan</th>
                                            ...
                                            {days.map((day) => (
                                                <tr key={day} className="border-b border-gray-200 hover:bg-gray-50">
                                                    ...
                                                    {['doa_pagi', 'baca_firman', 'catat_firman', 'ibadah', 'pelayanan'].map((activity) => (
                                                        <td key={activity} className="py-3 px-2">
