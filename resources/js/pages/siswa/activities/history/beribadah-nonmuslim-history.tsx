                                    ...
                                    <div key={day} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                                        ...
                                        <div className="p-4 space-y-3">
                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                {[
                                                    { label: 'Doa Pagi', color: 'blue' },
                                                    { label: 'Baca Firman', color: 'green' },
                                                    { label: 'Catat Firman', color: 'purple' },
                                                    { label: 'Ibadah', color: 'pink' },
                                                    { label: 'Pelayanan', color: 'orange' }
                                                ].map((item, idx) => (
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200 bg-gray-50">
                                                ...
                                                <th className="py-4 px-4 text-center font-bold text-gray-700 text-sm whitespace-nowrap">Catat Firman</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700 text-sm whitespace-nowrap">Ibadah</th>
