...
export default function BermasyarakatHistory({ auth, activity, submissions }: BermasyarakatHistoryProps) {
                                    ...
                                    return (
                                        <div key={day} className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                                            ...
                                            <div className="p-4 space-y-3">
                                                {/* Kegiatan Sosial - Grid Layout */}
                                                <div className="bg-blue-50 rounded-lg p-3">
                                                    <div className="text-xs text-gray-500 mb-3 font-semibold">Kegiatan Sosial:</div>
                                                    <div className="grid grid-cols-2 gap-2">
                                                        {submission?.details && Object.entries(submission.details).map(([key, detail]) => (
                                                            <div key={key} className={`flex items-center gap-2 p-2.5 rounded-lg border-2 ${detail.is_checked ? 'bg-green-50 border-green-500' : 'bg-white border-gray-200'}`}>
                                                                {detail.is_checked ? (
                                                                ...
                                                                <span className={`text-sm ${detail.is_checked ? 'text-gray-800 font-semibold' : 'text-gray-400'}`}>
                                                                    {detail.label}
                                                                </span>
                                                            </div>
                                                        ))}
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="border-b-2 border-gray-200 bg-gray-50">
                                                ...
                                                <th className="py-4 px-4 text-center font-bold text-gray-700 text-sm whitespace-nowrap">Tarka</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700 text-sm whitespace-nowrap">Kerja Bakti</th>
                                                <th className="py-4 px-4 text-center font-bold text-gray-700 text-sm whitespace-nowrap">Gotong Royong</th>
                                            ...
                                            {days.map((day) => {
                                                ...
                                                return (
                                                    <tr key={day} className="border-b border-gray-200 hover:bg-blue-50 transition-colors">
                                                        ...
                                                        <td className="py-4 px-4">
                                                            <div className="flex justify-center">
                                                                {submission?.details?.tarka?.is_checked ? (
                                                                    ...
                                                                    <div className="w-7 h-7 bg-gray-800 rounded"></div>
                                                                )}
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td className="py-4 px-4">
                                                            <div className="flex justify-center">
                                                                {submission?.details?.kerja_bakti?.is_checked ? (
                                                                    <div className="w-7 h-7 bg-gray-800 rounded flex items-center justify-center">
                                                                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                                                        </svg>
                                                        ...
                                                        <td className="py-4 px-4">
                                                            <div className="flex justify-center">
                                                                {submission?.details?.gotong_royong?.is_checked ? (
                                                                    <div className="w-7 h-7 bg-gray-800 rounded flex items-center justify-center">
                                                                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                                                        </svg>
                                                        ...
                                                        <td className="py-4 px-4">
                                                            <div className="flex justify-center">
                                                                {hasPhoto ? (
                                                                    <button
                                                                        onClick={() => handlePhotoClick(submission.photo!)}
                                                                        className="w-10 h-10 bg-gray-100 border-2 border-gray-300 rounded-lg flex items-center justify-center hover:bg-gray-200 transition-all"
                                                                    >
                                                        ...
                                                        <td className="py-4 px-4">
                                                            <div className="flex justify-center">
                                                                <button
                                                                    ...
                                                                    className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded-lg text-sm shadow-md transition-all"
                                                                >
                                                                    Lihat Detail
                                                                </button>
                                                            </div>
