...
export default function BerolahragaHistory({ auth, activity, submissions }: BerolahragaHistoryProps) {
                        ...
                        <div className="w-full lg:w-80 flex-shrink-0">
                            ...
                            <div className="bg-white rounded-xl sm:rounded-2xl md:rounded-3xl shadow-lg border-2 sm:border-3 md:border-4 border-blue-900 overflow-hidden mb-3 sm:mb-4 md:mb-6 relative">
                                ...
                                <div className={`${activity.color} p-3 sm:p-4 md:p-8 flex items-center justify-center`}>
                                    <div className="bg-blue-200 rounded-lg sm:rounded-xl md:rounded-2xl p-2 sm:p-3 md:p-6 w-full flex items-center justify-center min-h-[120px]">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="md:hidden space-y-3">
                                {days.map((day) => {
                                    ...
                                    const waktuBerolahraga = submission?.details.waktu_berolahraga?.value || '';
