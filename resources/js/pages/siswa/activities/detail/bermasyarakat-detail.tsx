                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-8 border-4 border-gray-800">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center gap-4">
                                <label className="w-48 font-semibold text-gray-700">KEGIATAN BERMASYARAKAT</label>
                                <div className="flex-1 flex items-center gap-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-gray-600">
                                            {bermasyarakat ? 'Sudah melakukan kegiatan sosial' : 'Belum melakukan kegiatan sosial'}
                                        </span>
                                    </div>
                                    <Button
                                        type="button"
